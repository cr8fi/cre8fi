...
export default function MultiStepsForm() {
  const { steps, currentStepIndex, step, next, back, isFirstStep, isLastStep } =
    useMultistepsForm([<Form1 />, <Form2 />, <Form3 />, <Form4 />]);
  return (
    <form className="w-full h-svh flex justify-center items-center font-[Sora] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#120C7A] to-[#030214]">
      <div className="w-11/12 md:w-[37.5rem] rounded-2xl p-1 bg-gradient-to-b from-[#4565DB] to-[#9C39FF] overflow-hidden">
        <article className="bg-gradient-to-b from-[#343E63] to-[#121318] rounded-xl">
          ...
          <section className="md:py-10 py-5 md:px-20 px-10 flex flex-col gap-10">
            ...
            <div className="flex justify-between w-full gap-4">
              ...
              <Button onClick={next} text={isLastStep ? "Submit" : "Next"} />
            </div>
          </section>
        </article>
      </div>
