...
export default function OnBoarding() {
  ...
  const PROJECT_STEPS = [
    <ProjectForm2 {...data} updateFields={updateFields} />,
    <ProjectForm3 {...data} updateFields={updateFields} />,
    <ProjectForm4 {...data} updateFields={updateFields} />,
  ];
